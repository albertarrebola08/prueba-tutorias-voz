        ...
        <Card className="flex-1 relative overflow-hidden shadow-2xl">
          <div className="absolute inset-0">
            <Avatar className="w-full h-full rounded-lg">
              ...
              />
              <AvatarFallback className="w-full h-full bg-gradient-to-br from-blue-400 to-purple-500 text-white text-6xl font-raleway">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              >
                <span className="font-opensans">{currentAlumno.edad} años</span>
              </Badge>
              <Badge
                variant="secondary"
                className="bg-white/20 text-white border-white/30"
              >
                <span className="font-opensans">{currentAlumno.grupo}</span>
              </Badge>
            </div>
            ...
            <div className="flex gap-4 mb-4">
              <Button
                ...
                className="flex-1 bg-green-500 hover:bg-green-600 text-white font-opensans font-medium"
              >
              ...
              <Button
                ...
                className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-opensans font-medium"
              >
            ...
            <Button
              ...
              className="w-full text-white hover:bg-white/20 font-opensans"
            >
              {showDetails ? (
                <>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="font-raleway font-bold text-2xl text-green-600">
                  ...
                  {currentAlumno.ultimaEntrevista && (
                    <div className="font-opensans text-xs text-gray-500 mt-1">
                      Última:{" "}
                ...
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <div className="font-raleway font-bold text-2xl text-blue-600">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-raleway font-medium text-gray-900 mb-2">
                    Última Entrevista
                  </h4>
                  <p className="font-opensans text-sm text-gray-600">
